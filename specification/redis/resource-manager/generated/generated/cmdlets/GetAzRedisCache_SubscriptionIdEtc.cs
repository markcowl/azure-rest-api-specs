namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzRedisCache_SubscriptionIdEtc")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.Api20180301.IRedisResource))]
    [Sample.API.Description(@"Gets all Redis caches in the specified subscription.")]
    [Sample.API.Generated]
    [Sample.API.Profile("latest", "sample")]
    public partial class GetAzRedisCache_SubscriptionIdEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetAzRedisCache_SubscriptionIdEtc</returns>
        public Sample.API.Cmdlets.GetAzRedisCache_SubscriptionIdEtc Clone()
        {
        ...
        /// <returns>an instance of GetAzRedisCache_SubscriptionIdEtc.</returns>
        public static Sample.API.Cmdlets.GetAzRedisCache_SubscriptionIdEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new GetAzRedisCache_SubscriptionIdEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetAzRedisCache_SubscriptionIdEtc" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetAzRedisCache_SubscriptionIdEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRedisCache_SubscriptionIdEtc" /> cmdlet class.
        /// </summary>
        public GetAzRedisCache_SubscriptionIdEtc()
        {
        }
        ...
        internal GetAzRedisCache_SubscriptionIdEtc(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisList(SubscriptionId, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzRedisCache_SubscriptionIdEtc" /> as a <see cref="Sample.API.Runtime.Json.JsonNode" />.
        /// </returns>
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.RedisList_Call(requestMessage, onOK, this, Pipeline);
                    }
                }
            }
        }
