namespace Sample.API.Cmdlets
{
    ...
    /// data loss.
    /// </summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsLifecycle.Invoke, @"AzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootType", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootType : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20171001.IRedisRebootParameters _parameters;

        /// <summary>Specifies which Redis node(s) to reboot.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Specifies which Redis node(s) to reboot.", ValueFromPipeline = true)]
        public Sample.API.Models.Api20171001.IRedisRebootParameters Parameters
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootType
        /// </returns>
        public Sample.API.Cmdlets.InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootType Clone()
        {
        ...
        /// <returns>
        /// an instance of InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootType.
        /// </returns>
        public static Sample.API.Cmdlets.InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootType FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootType(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootType"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootType FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootType"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootType()
        {
        }
        ...
        internal InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootType(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parameters = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("Parameters"), out var __jsonParameters) ? Sample.API.Models.Api20171001.RedisRebootParameters.FromJson(__jsonParameters) : Parameters;}
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisForceReboot(ResourceGroupName, Name, ApiVersion, SubscriptionId, Parameters, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootType"
