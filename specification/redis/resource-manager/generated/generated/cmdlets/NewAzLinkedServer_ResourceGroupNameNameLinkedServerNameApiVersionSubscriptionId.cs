namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"AzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionId", SupportsShouldProcess = true)]
    ...
    public partial class NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionId : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20171001.IRedisLinkedServerCreateParameters _parameters;

        /// <summary>Parameter required for creating a linked server to redis cache.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameter required for creating a linked server to redis cache.", ValueFromPipeline = true)]
        public Sample.API.Models.Api20171001.IRedisLinkedServerCreateParameters Parameters
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionId
        /// </returns>
        public Sample.API.Cmdlets.NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionId Clone()
        {
        ...
        /// <returns>
        /// an instance of NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionId.
        /// </returns>
        public static Sample.API.Cmdlets.NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionId FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionId(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionId"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionId FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionId"
        /// /> cmdlet class.
        /// </summary>
        public NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionId()
        {
        }
        ...
        internal NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionId(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parameters = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("Parameters"), out var __jsonParameters) ? Sample.API.Models.Api20171001.RedisLinkedServerCreateParameters.FromJson(__jsonParameters) : Parameters;}
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.LinkedServerCreate(ResourceGroupName, Name, LinkedServerName, ApiVersion, SubscriptionId, Parameters, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionId" />
