namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzRedisCache_ResourceGroupNameNameEtc")]
    ...
    public partial class GetAzRedisCache_ResourceGroupNameNameEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetAzRedisCache_ResourceGroupNameNameEtc</returns>
        public Sample.API.Cmdlets.GetAzRedisCache_ResourceGroupNameNameEtc Clone()
        {
        ...
        /// <returns>an instance of GetAzRedisCache_ResourceGroupNameNameEtc.</returns>
        public static Sample.API.Cmdlets.GetAzRedisCache_ResourceGroupNameNameEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new GetAzRedisCache_ResourceGroupNameNameEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetAzRedisCache_ResourceGroupNameNameEtc" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetAzRedisCache_ResourceGroupNameNameEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRedisCache_ResourceGroupNameNameEtc" /> cmdlet class.
        /// </summary>
        public GetAzRedisCache_ResourceGroupNameNameEtc()
        {
        }
        ...
        internal GetAzRedisCache_ResourceGroupNameNameEtc(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzRedisCache_ResourceGroupNameNameEtc" /> as a <see cref="Sample.API.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
