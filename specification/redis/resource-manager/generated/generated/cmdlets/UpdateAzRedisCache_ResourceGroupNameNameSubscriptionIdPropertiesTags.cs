namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"AzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTags", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTags : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20171001.IRedisUpdateParameters _parameters;
        ...
        public Sample.API.Models.Api20171001.IRedisUpdateParameters Parameters
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTags
        /// </returns>
        public Sample.API.Cmdlets.UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTags Clone()
        {
        ...
        /// <returns>
        /// an instance of UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTags.
        /// </returns>
        public static Sample.API.Cmdlets.UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTags FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTags(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTags" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTags FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        /// <returns>
        /// a serialized instance of <see cref="UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTags" /> as a <see
        ...
        internal UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTags(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parameters = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("Parameters"), out var __jsonParameters) ? Sample.API.Models.Api20171001.RedisUpdateParameters.FromJson(__jsonParameters) : Parameters;}
        }
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTags" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTags()
        {
        }
