namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzRedisCache_ResourceGroupResourceGroupNameSubscriptionIdEtc")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.Api20180301.IRedisResource))]
    [Sample.API.Description(@"Lists all Redis caches in a resource group.")]
    [Sample.API.Generated]
    [Sample.API.Profile("latest", "sample")]
    public partial class GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionIdEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionIdEtc
        /// </returns>
        public Sample.API.Cmdlets.GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionIdEtc Clone()
        {
        ...
        /// <returns>an instance of GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionIdEtc.</returns>
        public static Sample.API.Cmdlets.GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionIdEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionIdEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionIdEtc" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionIdEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionIdEtc" /> cmdlet
        /// class.
        /// </summary>
        public GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionIdEtc()
        {
        }
        ...
        internal GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionIdEtc(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisListByResourceGroup(ResourceGroupName, SubscriptionId, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionIdEtc" /> as a <see cref="Sample.API.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.Api20180301.IRedisListResult" /> from the remote
        /// call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.Api20180301.IRedisListResult> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.RedisListByResourceGroup_Call(requestMessage, onOK, this, Pipeline);
                    }
                }
            }
        }
