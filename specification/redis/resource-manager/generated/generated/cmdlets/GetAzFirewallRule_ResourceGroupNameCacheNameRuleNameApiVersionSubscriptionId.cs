namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionId")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.Api20171001.IRedisFirewallRule))]
    [Sample.API.Description(@"Gets a single firewall rule in a specified redis cache.")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class GetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionId : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of GetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionId
        /// </returns>
        public Sample.API.Cmdlets.GetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionId Clone()
        {
        ...
        /// <returns>
        /// an instance of GetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionId.
        /// </returns>
        public static Sample.API.Cmdlets.GetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionId FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new GetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionId(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionId"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionId FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionId"
        /// /> cmdlet class.
        /// </summary>
        public GetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionId()
        {
        }
        ...
        internal GetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionId(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FirewallRulesGet(ResourceGroupName, CacheName, RuleName, ApiVersion, SubscriptionId, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionId" /> as
