namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"AzPatchSchedule_ResourceGroupNameNameApiVersion", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzPatchSchedule_ResourceGroupNameNameApiVersion : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzPatchSchedule_ResourceGroupNameNameApiVersion</returns>
        public Sample.API.Cmdlets.RemoveAzPatchSchedule_ResourceGroupNameNameApiVersion Clone()
        {
        ...
        /// <returns>an instance of RemoveAzPatchSchedule_ResourceGroupNameNameApiVersion.</returns>
        public static Sample.API.Cmdlets.RemoveAzPatchSchedule_ResourceGroupNameNameApiVersion FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new RemoveAzPatchSchedule_ResourceGroupNameNameApiVersion(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="RemoveAzPatchSchedule_ResourceGroupNameNameApiVersion" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.RemoveAzPatchSchedule_ResourceGroupNameNameApiVersion FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzPatchSchedule_ResourceGroupNameNameApiVersion" /> cmdlet class.
        /// </summary>
        public RemoveAzPatchSchedule_ResourceGroupNameNameApiVersion()
        {
        }
        ...
        internal RemoveAzPatchSchedule_ResourceGroupNameNameApiVersion(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="RemoveAzPatchSchedule_ResourceGroupNameNameApiVersion" /> as a <see cref="Sample.API.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
