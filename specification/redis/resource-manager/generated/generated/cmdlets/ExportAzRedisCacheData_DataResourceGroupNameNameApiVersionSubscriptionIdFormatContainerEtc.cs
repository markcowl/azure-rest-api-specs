namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Export, @"AzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainerEtc", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [Sample.API.Description(@"Export data from the redis cache to blobs in a container.")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainerEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Container name to export to.")]
        public string Container
        {
            set
            {
                ParametersBody.Container = value;
            }
        }
        /// <summary>
        ...
        [System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "File format.")]
        public string Format
        {
            set
            {
                ParametersBody.Format = value;
            }
        }
        ...
        private Sample.API.Models.Api20171001.IExportRDBParameters _parametersBody= new Sample.API.Models.Api20171001.ExportRDBParameters();

        /// <summary>Parameters for Redis export operation.</summary>
        private Sample.API.Models.Api20171001.IExportRDBParameters ParametersBody
        {
            get
            {
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Prefix to use for exported files.")]
        public string Prefix
        {
            set
            {
                ParametersBody.Prefix = value;
            }
        }
        ...
        /// <returns>
        /// a duplicate instance of ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainerEtc
        /// </returns>
        public Sample.API.Cmdlets.ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainerEtc Clone()
        {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainerEtc"
        /// /> cmdlet class.
        /// </summary>
        public ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainerEtc()
        {
        }
        ...
        internal ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainerEtc(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parametersBody = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("ParametersBody"), out var __jsonParametersBody) ? Sample.API.Models.Api20171001.ExportRDBParameters.FromJson(__jsonParametersBody) : ParametersBody;}
        }
        /// <summary>
        ...
        /// <returns>
        /// an instance of ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainerEtc.
        /// </returns>
        public static Sample.API.Cmdlets.ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainerEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainerEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainerEtc"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainerEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisExportData(ResourceGroupName, Name, ApiVersion, SubscriptionId, ParametersBody, onOK, onNoContent, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainerEtc"
