namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"AzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtcEtc", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.Api20171001.IRedisFirewallRule))]
    [Sample.API.Description(@"Create or update a redis cache firewall rule")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtcEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20171001.IRedisFirewallRuleCreateParameters _parametersBody= new Sample.API.Models.Api20171001.RedisFirewallRuleCreateParameters();

        /// <summary>Parameters required for creating a firewall rule on redis cache.</summary>
        private Sample.API.Models.Api20171001.IRedisFirewallRuleCreateParameters ParametersBody
        {
            get
            {
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "highest IP address included in the range")]
        public string RedisFirewallRulePropertiesEndIP
        {
            set
            {
                ParametersBody.Properties = ParametersBody.Properties ?? new Sample.API.Models.Api20171001.RedisFirewallRuleProperties();
                ParametersBody.Properties.EndIP = value;
            }
        }
        /// <summary>lowest IP address included in the range</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "lowest IP address included in the range")]
        public string RedisFirewallRulePropertiesStartIP
        {
            set
            {
                ParametersBody.Properties = ParametersBody.Properties ?? new Sample.API.Models.Api20171001.RedisFirewallRuleProperties();
                ParametersBody.Properties.StartIP = value;
            }
        }
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the firewall rule.")]
        ...
        /// <returns>
        /// a duplicate instance of SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtcEtc
        /// </returns>
        public Sample.API.Cmdlets.SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtcEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtcEtc.
        /// </returns>
        public static Sample.API.Cmdlets.SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtcEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtcEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtcEtc"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtcEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FirewallRulesCreateOrUpdate(ResourceGroupName, CacheName, RuleName, ApiVersion, SubscriptionId, ParametersBody, onOK, onCreated, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtcEtc"
        /// /> cmdlet class.
        /// </summary>
        public SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtcEtc()
        {
        }
        ...
        internal SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtcEtc(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_cacheName = If( json?.PropertyT<Sample.API.Runtime.Json.JsonString>("CacheName"), out var __jsonCacheName) ? (string)__jsonCacheName : (string)CacheName;}
            {_ruleName = If( json?.PropertyT<Sample.API.Runtime.Json.JsonString>("RuleName"), out var __jsonRuleName) ? (string)__jsonRuleName : (string)RuleName;}
            ...
            {_parametersBody = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("ParametersBody"), out var __jsonParametersBody) ? Sample.API.Models.Api20171001.RedisFirewallRuleCreateParameters.FromJson(__jsonParametersBody) : ParametersBody;}
        }
        ...
        /// <returns>
        /// a serialized instance of <see cref="SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtcEtc"
        ...
        public Sample.API.Runtime.Json.JsonNode ToJson(Sample.API.Runtime.Json.JsonObject container, Sample.API.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)CacheName)?.ToString()) ? (Sample.API.Runtime.Json.JsonNode) new Sample.API.Runtime.Json.JsonString(CacheName.ToString()) : null, "CacheName" ,container.Add );
            AddIf( null != (((object)RuleName)?.ToString()) ? (Sample.API.Runtime.Json.JsonNode) new Sample.API.Runtime.Json.JsonString(RuleName.ToString()) : null, "RuleName" ,container.Add );
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.Api20171001.IRedisFirewallRule" /> from the remote
        /// call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onCreated(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.Api20171001.IRedisFirewallRule> response)
        {
            using( NoSynchronizationContext )
            {
                // onCreated - response for 201 / application/json
                // (await response) // should be Sample.API.Models.Api20171001.IRedisFirewallRule
        ...
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.Api20171001.IRedisFirewallRule> response)
        {
            using( NoSynchronizationContext )
            {
