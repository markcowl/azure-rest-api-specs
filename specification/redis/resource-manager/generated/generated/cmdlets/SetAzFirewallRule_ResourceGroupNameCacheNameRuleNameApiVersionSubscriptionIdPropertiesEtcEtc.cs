namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"AzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtc", SupportsShouldProcess = true)]
    ...
    public partial class SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20171001.IRedisFirewallRuleCreateParameters _parameters;

        /// <summary>Parameters required for creating a firewall rule on redis cache.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters required for creating a firewall rule on redis cache.", ValueFromPipeline = true)]
        public Sample.API.Models.Api20171001.IRedisFirewallRuleCreateParameters Parameters
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtc
        /// </returns>
        public Sample.API.Cmdlets.SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtc.
        /// </returns>
        public static Sample.API.Cmdlets.SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtc"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FirewallRulesCreateOrUpdate(ResourceGroupName, CacheName, RuleName, ApiVersion, SubscriptionId, Parameters, onOK, onCreated, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtc"
        /// /> cmdlet class.
        /// </summary>
        public SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtc()
        {
        }
        ...
        internal SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtc(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parameters = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("Parameters"), out var __jsonParameters) ? Sample.API.Models.Api20171001.RedisFirewallRuleCreateParameters.FromJson(__jsonParameters) : Parameters;}
        }
        ...
        /// <returns>
        /// a serialized instance of <see cref="SetAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdPropertiesEtcEtc"
        ...
        public Sample.API.Runtime.Json.JsonNode ToJson(Sample.API.Runtime.Json.JsonObject container, Sample.API.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != Parameters ? (Sample.API.Runtime.Json.JsonNode) Parameters.ToJson(null) : null, "Parameters" ,container.Add );
            return container;
        }
