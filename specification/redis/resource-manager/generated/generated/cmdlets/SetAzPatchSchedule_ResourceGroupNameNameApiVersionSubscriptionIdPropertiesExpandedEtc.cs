namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"AzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesExpandedEtc", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.Api20171001.IRedisPatchSchedule))]
    [Sample.API.Description(@"Create or replace the patching schedule for Redis cache (requires Premium SKU).")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesExpandedEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20171001.IRedisPatchSchedule _parametersBody= new Sample.API.Models.Api20171001.RedisPatchSchedule();

        /// <summary>Response to put/get patch schedules for Redis cache.</summary>
        private Sample.API.Models.Api20171001.IRedisPatchSchedule ParametersBody
        {
            get
            {
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "List of patch schedules for a Redis cache.")]
        public Sample.API.Models.Api20171001.IScheduleEntry[] ScheduleEntriesProperty
        {
            set
            {
                ParametersBody.Properties = ParametersBody.Properties ?? new Sample.API.Models.Api20171001.ScheduleEntries();
                ParametersBody.Properties.Property = value;
            }
        }
        ...
        /// <returns>
        /// a duplicate instance of SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesExpandedEtc
        /// </returns>
        public Sample.API.Cmdlets.SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesExpandedEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesExpandedEtc.
        /// </returns>
        public static Sample.API.Cmdlets.SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesExpandedEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesExpandedEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesExpandedEtc"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesExpandedEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PatchSchedulesCreateOrUpdate(ResourceGroupName, Name, ApiVersion, SubscriptionId, ParametersBody, onOK, onCreated, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesExpandedEtc"
        /// /> cmdlet class.
        /// </summary>
        public SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesExpandedEtc()
        {
        }
        ...
        internal SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesExpandedEtc(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parametersBody = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("ParametersBody"), out var __jsonParametersBody) ? Sample.API.Models.Api20171001.RedisPatchSchedule.FromJson(__jsonParametersBody) : ParametersBody;}
        }
        ...
        /// <returns>
        /// a serialized instance of <see cref="SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesExpandedEtc"
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.Api20171001.IRedisPatchSchedule" /> from the
        /// remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onCreated(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.Api20171001.IRedisPatchSchedule> response)
        {
            using( NoSynchronizationContext )
            {
                // onCreated - response for 201 / application/json
                // (await response) // should be Sample.API.Models.Api20171001.IRedisPatchSchedule
        ...
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.Api20171001.IRedisPatchSchedule> response)
        {
            using( NoSynchronizationContext )
            {
