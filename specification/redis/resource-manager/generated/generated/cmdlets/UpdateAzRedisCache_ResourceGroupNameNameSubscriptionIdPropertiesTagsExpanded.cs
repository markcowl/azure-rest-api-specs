namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"AzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsExpanded : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20171001.IRedisUpdateParameters _parametersBody= new Sample.API.Models.Api20171001.RedisUpdateParameters();

        /// <summary>Parameters supplied to the Update Redis operation.</summary>
        private Sample.API.Models.Api20171001.IRedisUpdateParameters ParametersBody
        {
            get
            {
        ...
        public int SkuCapacity
        {
            set
            {
                ParametersBody.Properties = ParametersBody.Properties ?? new Sample.API.Models.Api20171001.RedisUpdateProperties();
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsExpanded
        /// </returns>
        public Sample.API.Cmdlets.UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsExpanded Clone()
        {
        ...
        /// <returns>
        /// an instance of UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsExpanded.
        /// </returns>
        public static Sample.API.Cmdlets.UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsExpanded FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsExpanded"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        /// <returns>
        /// a serialized instance of <see cref="UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsExpanded" /> as
        ...
        internal UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsExpanded(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parametersBody = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("ParametersBody"), out var __jsonParametersBody) ? Sample.API.Models.Api20171001.RedisUpdateParameters.FromJson(__jsonParametersBody) : ParametersBody;}
        }
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsExpanded()
        {
        }
