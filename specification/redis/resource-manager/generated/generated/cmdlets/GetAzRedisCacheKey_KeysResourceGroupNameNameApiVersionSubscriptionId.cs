namespace Sample.API.Cmdlets
{
    ...
    /// </summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzRedisCacheKey_KeysResourceGroupNameNameApiVersionSubscriptionId", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.Api20171001.IRedisAccessKeys))]
    [Sample.API.Description(@"Retrieve a Redis cache's access keys. This operation requires write permission to the cache resource.")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class GetAzRedisCacheKey_KeysResourceGroupNameNameApiVersionSubscriptionId : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of GetAzRedisCacheKey_KeysResourceGroupNameNameApiVersionSubscriptionId
        /// </returns>
        public Sample.API.Cmdlets.GetAzRedisCacheKey_KeysResourceGroupNameNameApiVersionSubscriptionId Clone()
        {
        ...
        /// <returns>
        /// an instance of GetAzRedisCacheKey_KeysResourceGroupNameNameApiVersionSubscriptionId.
        /// </returns>
        public static Sample.API.Cmdlets.GetAzRedisCacheKey_KeysResourceGroupNameNameApiVersionSubscriptionId FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new GetAzRedisCacheKey_KeysResourceGroupNameNameApiVersionSubscriptionId(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetAzRedisCacheKey_KeysResourceGroupNameNameApiVersionSubscriptionId" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetAzRedisCacheKey_KeysResourceGroupNameNameApiVersionSubscriptionId FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRedisCacheKey_KeysResourceGroupNameNameApiVersionSubscriptionId" /> cmdlet
        /// class.
        /// </summary>
        public GetAzRedisCacheKey_KeysResourceGroupNameNameApiVersionSubscriptionId()
        {
        }
        ...
        internal GetAzRedisCacheKey_KeysResourceGroupNameNameApiVersionSubscriptionId(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisListKeys(ResourceGroupName, Name, ApiVersion, SubscriptionId, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzRedisCacheKey_KeysResourceGroupNameNameApiVersionSubscriptionId" /> as a <see
