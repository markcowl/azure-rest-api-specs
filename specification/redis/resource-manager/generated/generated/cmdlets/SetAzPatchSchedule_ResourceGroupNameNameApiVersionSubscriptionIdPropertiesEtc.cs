namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Set, @"AzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesEtc", SupportsShouldProcess = true)]
    ...
    public partial class SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20171001.IRedisPatchSchedule _parameters;

        /// <summary>Response to put/get patch schedules for Redis cache.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Response to put/get patch schedules for Redis cache.", ValueFromPipeline = true)]
        public Sample.API.Models.Api20171001.IRedisPatchSchedule Parameters
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesEtc
        /// </returns>
        public Sample.API.Cmdlets.SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesEtc.
        /// </returns>
        public static Sample.API.Cmdlets.SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesEtc"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PatchSchedulesCreateOrUpdate(ResourceGroupName, Name, ApiVersion, SubscriptionId, Parameters, onOK, onCreated, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesEtc"
        /// /> cmdlet class.
        /// </summary>
        public SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesEtc()
        {
        }
        ...
        internal SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesEtc(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parameters = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("Parameters"), out var __jsonParameters) ? Sample.API.Models.Api20171001.RedisPatchSchedule.FromJson(__jsonParameters) : Parameters;}
        }
        ...
        /// <returns>
        /// a serialized instance of <see cref="SetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdPropertiesEtc" />
