namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"AzRedisCache_ResourceGroupNameNameSubscriptionIdEtcEtc", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [Sample.API.Description(@"Deletes a Redis cache.")]
    [Sample.API.Generated]
    [Sample.API.Profile("latest", "sample")]
    public partial class RemoveAzRedisCache_ResourceGroupNameNameSubscriptionIdEtcEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of RemoveAzRedisCache_ResourceGroupNameNameSubscriptionIdEtcEtc
        /// </returns>
        public Sample.API.Cmdlets.RemoveAzRedisCache_ResourceGroupNameNameSubscriptionIdEtcEtc Clone()
        {
        ...
        /// <returns>an instance of RemoveAzRedisCache_ResourceGroupNameNameSubscriptionIdEtcEtc.</returns>
        public static Sample.API.Cmdlets.RemoveAzRedisCache_ResourceGroupNameNameSubscriptionIdEtcEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new RemoveAzRedisCache_ResourceGroupNameNameSubscriptionIdEtcEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="RemoveAzRedisCache_ResourceGroupNameNameSubscriptionIdEtcEtc" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.RemoveAzRedisCache_ResourceGroupNameNameSubscriptionIdEtcEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'RedisDelete' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisDelete(ResourceGroupName, Name, SubscriptionId, onOK, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzRedisCache_ResourceGroupNameNameSubscriptionIdEtcEtc" /> cmdlet class.
        /// </summary>
        public RemoveAzRedisCache_ResourceGroupNameNameSubscriptionIdEtcEtc()
        {
        }
        ...
        internal RemoveAzRedisCache_ResourceGroupNameNameSubscriptionIdEtcEtc(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="RemoveAzRedisCache_ResourceGroupNameNameSubscriptionIdEtcEtc" /> as a <see cref="Sample.API.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
