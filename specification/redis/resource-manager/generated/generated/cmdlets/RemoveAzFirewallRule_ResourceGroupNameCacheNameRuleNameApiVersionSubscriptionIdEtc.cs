namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"AzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdEtc", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [Sample.API.Description(@"Deletes a single firewall rule in a specified redis cache.")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class RemoveAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of RemoveAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdEtc
        /// </returns>
        public Sample.API.Cmdlets.RemoveAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of RemoveAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdEtc.
        /// </returns>
        public static Sample.API.Cmdlets.RemoveAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new RemoveAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="RemoveAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdEtc"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.RemoveAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FirewallRulesDelete(ResourceGroupName, CacheName, RuleName, ApiVersion, SubscriptionId, onOK, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdEtc"
        /// /> cmdlet class.
        /// </summary>
        public RemoveAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdEtc()
        {
        }
        ...
        internal RemoveAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdEtc(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="RemoveAzFirewallRule_ResourceGroupNameCacheNameRuleNameApiVersionSubscriptionIdEtc"
