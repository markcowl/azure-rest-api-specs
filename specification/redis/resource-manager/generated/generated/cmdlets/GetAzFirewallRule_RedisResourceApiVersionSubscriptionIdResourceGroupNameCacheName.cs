namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzFirewallRule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheName")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.Api20171001.IRedisFirewallRule))]
    [Sample.API.Description(@"Gets all firewall rules in the specified redis cache.")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class GetAzFirewallRule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheName : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of GetAzFirewallRule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheName
        /// </returns>
        public Sample.API.Cmdlets.GetAzFirewallRule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheName Clone()
        {
        ...
        /// <returns>
        /// an instance of GetAzFirewallRule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheName.
        /// </returns>
        public static Sample.API.Cmdlets.GetAzFirewallRule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheName FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new GetAzFirewallRule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheName(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetAzFirewallRule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheName"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetAzFirewallRule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheName FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzFirewallRule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheName"
        /// /> cmdlet class.
        /// </summary>
        public GetAzFirewallRule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheName()
        {
        }
        ...
        internal GetAzFirewallRule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheName(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.FirewallRulesListByRedisResource(ApiVersion, SubscriptionId, ResourceGroupName, CacheName, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzFirewallRule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheName"
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.Api20171001.IRedisFirewallRuleListResult" />
        /// from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.Api20171001.IRedisFirewallRuleListResult> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.FirewallRulesListByRedisResource_Call(requestMessage, onOK, this, Pipeline);
                    }
                }
            }
        }
