namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Import, @"AzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFilesExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [Sample.API.Description(@"Import data into Redis cache.")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFilesExpanded : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "files to import.")]
        public string[] Files
        {
            set
            {
                ParametersBody.Files = value;
            }
        }
        ...
        private Sample.API.Models.Api20171001.IImportRDBParameters _parametersBody= new Sample.API.Models.Api20171001.ImportRDBParameters();

        /// <summary>Parameters for Redis import operation.</summary>
        private Sample.API.Models.Api20171001.IImportRDBParameters ParametersBody
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFilesExpanded
        /// </returns>
        public Sample.API.Cmdlets.ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFilesExpanded Clone()
        {
        ...
        /// <returns>
        /// an instance of ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFilesExpanded.
        /// </returns>
        public static Sample.API.Cmdlets.ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFilesExpanded FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFilesExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFilesExpanded"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFilesExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFilesExpanded"
        /// /> cmdlet class.
        /// </summary>
        public ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFilesExpanded()
        {
        }
        ...
        internal ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFilesExpanded(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parametersBody = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("ParametersBody"), out var __jsonParametersBody) ? Sample.API.Models.Api20171001.ImportRDBParameters.FromJson(__jsonParametersBody) : ParametersBody;}
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisImportData(ResourceGroupName, Name, ApiVersion, SubscriptionId, ParametersBody, onOK, onNoContent, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFilesExpanded"
