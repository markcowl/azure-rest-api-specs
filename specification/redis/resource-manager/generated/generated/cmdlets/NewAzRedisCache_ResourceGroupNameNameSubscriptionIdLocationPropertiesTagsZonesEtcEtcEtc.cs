namespace Sample.API.Cmdlets
{
    ...
    /// </summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"AzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtcEtc", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.Api20180301.IRedisResource))]
    [Sample.API.Description(@"Create or replace (overwrite/recreate, with potential downtime) an existing Redis cache.")]
    [Sample.API.Generated]
    [Sample.API.Profile("latest", "sample")]
    public partial class NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtcEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The geo-location where the resource lives")]
        public string Location
        {
            set
            {
                ParametersBody.Location = value;
            }
        }
        /// <summary>
        ...
        private Sample.API.Models.Api20180301.IRedisCreateParameters _parametersBody= new Sample.API.Models.Api20180301.RedisCreateParameters();

        /// <summary>Parameters supplied to the Create Redis operation.</summary>
        private Sample.API.Models.Api20180301.IRedisCreateParameters ParametersBody
        {
            get
            {
        ...
        /// </summary>
        [System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Static IP address. Required when deploying a Redis cache inside an existing Azure Virtual Network.")]
        public string RedisCreatePropertiesStaticIP
        {
            set
            {
                ParametersBody.Properties = ParametersBody.Properties ?? new Sample.API.Models.Api20180301.RedisCreateProperties();
                ParametersBody.Properties.StaticIP = value;
            }
        }
        /// <summary>
        /// The full resource ID of a subnet in a virtual network to deploy the Redis cache in. Example format: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/Microsoft.{Network|ClassicNetwork}/VirtualNetworks/vnet1/subnets/subnet1
        /// </summary>
        [System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The full resource ID of a subnet in a virtual network to deploy the Redis cache in. Example format: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/Microsoft.{Network|ClassicNetwork}/VirtualNetworks/vnet1/subnets/subnet1")]
        public string RedisCreatePropertiesSubnetId
        {
            set
            {
                ParametersBody.Properties = ParametersBody.Properties ?? new Sample.API.Models.Api20180301.RedisCreateProperties();
                ParametersBody.Properties.SubnetId = value;
            }
        }
        ...
        [System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "A list of availability zones denoting where the resource needs to come from.")]
        public string[] Zones
        {
            set
            {
                ParametersBody.Zones = value;
            }
        }
        /// <summary>
        ...
        /// <returns>
        /// a duplicate instance of NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtcEtc
        /// </returns>
        public Sample.API.Cmdlets.NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtcEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtcEtc.
        /// </returns>
        public static Sample.API.Cmdlets.NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtcEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtcEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtcEtc"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtcEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtcEtc"
        /// /> cmdlet class.
        /// </summary>
        public NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtcEtc()
        {
        }
        ...
        internal NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtcEtc(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parametersBody = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("ParametersBody"), out var __jsonParametersBody) ? Sample.API.Models.Api20180301.RedisCreateParameters.FromJson(__jsonParametersBody) : ParametersBody;}
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisCreate(ResourceGroupName, Name, SubscriptionId, ParametersBody, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtcEtc"
