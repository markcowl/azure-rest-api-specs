namespace Sample.API.Cmdlets
{
    ...
    /// </summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtcEtc")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.Api20171001.IRedisLinkedServerWithProperties))]
    [Sample.API.Description(@"Gets the detailed information about a linked server of a redis cache (requires Premium SKU).")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class GetAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtcEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the linked server.")]
        ...
        /// <returns>
        /// a duplicate instance of GetAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtcEtc
        /// </returns>
        public Sample.API.Cmdlets.GetAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtcEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of GetAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtcEtc.
        /// </returns>
        public static Sample.API.Cmdlets.GetAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtcEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new GetAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtcEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtcEtc"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtcEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtcEtc"
        /// /> cmdlet class.
        /// </summary>
        public GetAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtcEtc()
        {
        }
        ...
        internal GetAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtcEtc(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.LinkedServerGet(ResourceGroupName, Name, LinkedServerName, ApiVersion, SubscriptionId, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtcEtc"
