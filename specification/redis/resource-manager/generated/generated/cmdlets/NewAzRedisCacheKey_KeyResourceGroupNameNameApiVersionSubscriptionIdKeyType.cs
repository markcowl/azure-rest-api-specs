namespace Sample.API.Cmdlets
{
    ...
    /// </summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"AzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyType", SupportsShouldProcess = true)]
    ...
    public partial class NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyType : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20171001.IRedisRegenerateKeyParameters _parameters;

        /// <summary>Specifies which Redis access keys to reset.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Specifies which Redis access keys to reset.", ValueFromPipeline = true)]
        public Sample.API.Models.Api20171001.IRedisRegenerateKeyParameters Parameters
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyType
        /// </returns>
        public Sample.API.Cmdlets.NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyType Clone()
        {
        ...
        /// <returns>
        /// an instance of NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyType.
        /// </returns>
        public static Sample.API.Cmdlets.NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyType FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyType(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyType" />
        /// cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyType FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyType"
        /// /> cmdlet class.
        /// </summary>
        public NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyType()
        {
        }
        ...
        internal NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyType(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parameters = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("Parameters"), out var __jsonParameters) ? Sample.API.Models.Api20171001.RedisRegenerateKeyParameters.FromJson(__jsonParameters) : Parameters;}
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisRegenerateKey(ResourceGroupName, Name, ApiVersion, SubscriptionId, Parameters, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyType" /> as
