namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"AzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionPropertiesExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.Api20171001.IRedisLinkedServerWithProperties))]
    [Sample.API.Description(@"Adds a linked server to the Redis cache (requires Premium SKU).")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionPropertiesExpanded : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The name of the linked server that is being added to the Redis cache.")]
        ...
        private Sample.API.Models.Api20171001.IRedisLinkedServerCreateParameters _parametersBody= new Sample.API.Models.Api20171001.RedisLinkedServerCreateParameters();

        /// <summary>Parameter required for creating a linked server to redis cache.</summary>
        private Sample.API.Models.Api20171001.IRedisLinkedServerCreateParameters ParametersBody
        {
            get
            {
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Fully qualified resourceId of the linked redis cache.")]
        public string RedisLinkedServerCreatePropertiesLinkedRedisCacheId
        {
            set
            {
                ParametersBody.Properties = ParametersBody.Properties ?? new Sample.API.Models.Api20171001.RedisLinkedServerCreateProperties();
                ParametersBody.Properties.LinkedRedisCacheId = value;
            }
        }
        /// <summary>Location of the linked redis cache.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Location of the linked redis cache.")]
        public string RedisLinkedServerCreatePropertiesLinkedRedisCacheLocation
        {
            set
            {
                ParametersBody.Properties = ParametersBody.Properties ?? new Sample.API.Models.Api20171001.RedisLinkedServerCreateProperties();
                ParametersBody.Properties.LinkedRedisCacheLocation = value;
            }
        }
        /// <summary>Role of the linked server.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Role of the linked server.")]
        [System.Management.Automation.ArgumentCompleter(typeof(Sample.API.Support.ReplicationRole))]
        public Sample.API.Support.ReplicationRole RedisLinkedServerCreatePropertiesServerRole
        {
            set
            {
                ParametersBody.Properties = ParametersBody.Properties ?? new Sample.API.Models.Api20171001.RedisLinkedServerCreateProperties();
                ParametersBody.Properties.ServerRole = value;
            }
        }
        ...
        /// <returns>
        /// a duplicate instance of NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionPropertiesExpanded
        /// </returns>
        public Sample.API.Cmdlets.NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionPropertiesExpanded Clone()
        {
        ...
        /// <returns>
        /// an instance of NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionPropertiesExpanded.
        /// </returns>
        public static Sample.API.Cmdlets.NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionPropertiesExpanded FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionPropertiesExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionPropertiesExpanded"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionPropertiesExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionPropertiesExpanded"
        /// /> cmdlet class.
        /// </summary>
        public NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionPropertiesExpanded()
        {
        }
        ...
        internal NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionPropertiesExpanded(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_linkedServerName = If( json?.PropertyT<Sample.API.Runtime.Json.JsonString>("LinkedServerName"), out var __jsonLinkedServerName) ? (string)__jsonLinkedServerName : (string)LinkedServerName;}
            {_parametersBody = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("ParametersBody"), out var __jsonParametersBody) ? Sample.API.Models.Api20171001.RedisLinkedServerCreateParameters.FromJson(__jsonParametersBody) : ParametersBody;}
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'LinkedServerCreate' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.LinkedServerCreate(ResourceGroupName, Name, LinkedServerName, ApiVersion, SubscriptionId, ParametersBody, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionPropertiesExpanded"
        ...
        public Sample.API.Runtime.Json.JsonNode ToJson(Sample.API.Runtime.Json.JsonObject container, Sample.API.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)LinkedServerName)?.ToString()) ? (Sample.API.Runtime.Json.JsonNode) new Sample.API.Runtime.Json.JsonString(LinkedServerName.ToString()) : null, "LinkedServerName" ,container.Add );
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.Api20171001.IRedisLinkedServerWithProperties"
        /// /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.Api20171001.IRedisLinkedServerWithProperties> response)
        {
            using( NoSynchronizationContext )
            {
                // onOK - response for 200 / application/json
                // (await response) // should be Sample.API.Models.Api20171001.IRedisLinkedServerWithProperties
