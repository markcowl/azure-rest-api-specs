namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"AzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtc", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [Sample.API.Description(@"Deletes the linked server from a redis cache (requires Premium SKU).")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class RemoveAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of RemoveAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtc
        /// </returns>
        public Sample.API.Cmdlets.RemoveAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of RemoveAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtc.
        /// </returns>
        public static Sample.API.Cmdlets.RemoveAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new RemoveAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="RemoveAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtc"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.RemoveAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'LinkedServerDelete' operation"))
                {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.LinkedServerDelete(ResourceGroupName, Name, LinkedServerName, ApiVersion, SubscriptionId, onOK, this, Pipeline);
        ...
        internal RemoveAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtc(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtc"
        /// /> cmdlet class.
        /// </summary>
        public RemoveAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtc()
        {
        }
        ...
        /// <returns>
        /// a serialized instance of <see cref="RemoveAzLinkedServer_ResourceGroupNameNameLinkedServerNameApiVersionSubscriptionIdEtcEtc"
