namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzRedisCache_Etc")]
    ...
    public partial class GetAzRedisCache_Etc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetAzRedisCache_Etc</returns>
        public Sample.API.Cmdlets.GetAzRedisCache_Etc Clone()
        {
        ...
        /// <returns>an instance of GetAzRedisCache_Etc.</returns>
        public static Sample.API.Cmdlets.GetAzRedisCache_Etc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new GetAzRedisCache_Etc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>returns a new instance of the <see cref="GetAzRedisCache_Etc" /> cmdlet</returns>
        public static Sample.API.Cmdlets.GetAzRedisCache_Etc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRedisCache_Etc" /> cmdlet class.
        /// </summary>
        public GetAzRedisCache_Etc()
        {
        }
        ...
        internal GetAzRedisCache_Etc(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzRedisCache_Etc" /> as a <see cref="Sample.API.Runtime.Json.JsonNode" />.
        /// </returns>
