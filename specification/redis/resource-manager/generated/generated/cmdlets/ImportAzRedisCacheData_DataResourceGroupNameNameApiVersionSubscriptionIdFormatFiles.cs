namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Import, @"AzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFiles", SupportsShouldProcess = true)]
    ...
    public partial class ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFiles : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20171001.IImportRDBParameters _parameters;

        /// <summary>Parameters for Redis import operation.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters for Redis import operation.", ValueFromPipeline = true)]
        public Sample.API.Models.Api20171001.IImportRDBParameters Parameters
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFiles
        /// </returns>
        public Sample.API.Cmdlets.ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFiles Clone()
        {
        ...
        /// <returns>
        /// an instance of ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFiles.
        /// </returns>
        public static Sample.API.Cmdlets.ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFiles FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFiles(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFiles"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFiles FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFiles"
        /// /> cmdlet class.
        /// </summary>
        public ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFiles()
        {
        }
        ...
        internal ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFiles(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parameters = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("Parameters"), out var __jsonParameters) ? Sample.API.Models.Api20171001.ImportRDBParameters.FromJson(__jsonParameters) : Parameters;}
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisImportData(ResourceGroupName, Name, ApiVersion, SubscriptionId, Parameters, onOK, onNoContent, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="ImportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatFiles"
