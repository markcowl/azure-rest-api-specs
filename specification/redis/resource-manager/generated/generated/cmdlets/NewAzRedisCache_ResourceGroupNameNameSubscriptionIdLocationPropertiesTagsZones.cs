namespace Sample.API.Cmdlets
{
    ...
    /// </summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"AzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZones", SupportsShouldProcess = true)]
    ...
    public partial class NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZones : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20171001.IRedisCreateParameters _parameters;
        ...
        public Sample.API.Models.Api20171001.IRedisCreateParameters Parameters
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZones
        /// </returns>
        public Sample.API.Cmdlets.NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZones Clone()
        {
        ...
        /// <returns>
        /// an instance of NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZones.
        /// </returns>
        public static Sample.API.Cmdlets.NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZones FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZones(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZones"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZones FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZones"
        /// /> cmdlet class.
        /// </summary>
        public NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZones()
        {
        }
        ...
        internal NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZones(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parameters = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("Parameters"), out var __jsonParameters) ? Sample.API.Models.Api20171001.RedisCreateParameters.FromJson(__jsonParameters) : Parameters;}
        }
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZones" />
