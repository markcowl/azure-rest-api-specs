namespace Sample.API.Cmdlets
{
    ...
    /// data loss.
    /// </summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsLifecycle.Invoke, @"AzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootTypeEtc", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(string))]
    [Sample.API.Description(@"Reboot specified Redis node(s). This operation requires write permission to the cache resource. There can be potential data loss.")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootTypeEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20171001.IRedisRebootParameters _parametersBody= new Sample.API.Models.Api20171001.RedisRebootParameters();

        /// <summary>Specifies which Redis node(s) to reboot.</summary>
        private Sample.API.Models.Api20171001.IRedisRebootParameters ParametersBody
        {
            get
            {
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Which Redis node(s) to reboot. Depending on this value data loss is possible.")]
        [System.Management.Automation.ArgumentCompleter(typeof(Sample.API.Support.RebootType))]
        public Sample.API.Support.RebootType RebootType
        {
            set
            {
                ParametersBody.RebootType = value;
            }
        }
        ...
        [System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "If clustering is enabled, the ID of the shard to be rebooted.")]
        public int ShardId
        {
            set
            {
                ParametersBody.ShardId = value;
            }
        }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootTypeEtc
        /// </returns>
        public Sample.API.Cmdlets.InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootTypeEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootTypeEtc.
        /// </returns>
        public static Sample.API.Cmdlets.InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootTypeEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootTypeEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootTypeEtc"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootTypeEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootTypeEtc"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootTypeEtc()
        {
        }
        ...
        internal InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootTypeEtc(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parametersBody = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("ParametersBody"), out var __jsonParametersBody) ? Sample.API.Models.Api20171001.RedisRebootParameters.FromJson(__jsonParametersBody) : ParametersBody;}
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisForceReboot(ResourceGroupName, Name, ApiVersion, SubscriptionId, ParametersBody, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="InvokeAzForceRedisCacheReboot_RebootResourceGroupNameNameApiVersionSubscriptionIdRebootTypeEtc"
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.Api20171001.IRedisForceRebootResponse" /> from
        /// the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.Api20171001.IRedisForceRebootResponse> response)
        {
            using( NoSynchronizationContext )
            {
                // onOK - response for 200 / application/json
                // (await response) // should be Sample.API.Models.Api20171001.IRedisForceRebootResponse
