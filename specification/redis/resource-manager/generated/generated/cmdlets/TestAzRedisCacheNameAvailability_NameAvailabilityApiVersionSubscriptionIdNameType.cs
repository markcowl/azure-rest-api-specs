namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsDiagnostic.Test, @"AzRedisCacheNameAvailability_NameAvailabilityApiVersionSubscriptionIdNameType", SupportsShouldProcess = true)]
    ...
    public partial class TestAzRedisCacheNameAvailability_NameAvailabilityApiVersionSubscriptionIdNameType : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20171001.ICheckNameAvailabilityParameters _parameters;

        /// <summary>Parameters body to pass for resource name availability check.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters body to pass for resource name availability check.", ValueFromPipeline = true)]
        public Sample.API.Models.Api20171001.ICheckNameAvailabilityParameters Parameters
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of TestAzRedisCacheNameAvailability_NameAvailabilityApiVersionSubscriptionIdNameType
        /// </returns>
        public Sample.API.Cmdlets.TestAzRedisCacheNameAvailability_NameAvailabilityApiVersionSubscriptionIdNameType Clone()
        {
        ...
        /// <returns>
        /// an instance of TestAzRedisCacheNameAvailability_NameAvailabilityApiVersionSubscriptionIdNameType.
        /// </returns>
        public static Sample.API.Cmdlets.TestAzRedisCacheNameAvailability_NameAvailabilityApiVersionSubscriptionIdNameType FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new TestAzRedisCacheNameAvailability_NameAvailabilityApiVersionSubscriptionIdNameType(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="TestAzRedisCacheNameAvailability_NameAvailabilityApiVersionSubscriptionIdNameType"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.TestAzRedisCacheNameAvailability_NameAvailabilityApiVersionSubscriptionIdNameType FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisCheckNameAvailability(ApiVersion, SubscriptionId, Parameters, onOK, this, Pipeline);
        ...
        internal TestAzRedisCacheNameAvailability_NameAvailabilityApiVersionSubscriptionIdNameType(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parameters = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("Parameters"), out var __jsonParameters) ? Sample.API.Models.Api20171001.CheckNameAvailabilityParameters.FromJson(__jsonParameters) : Parameters;}
        }
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzRedisCacheNameAvailability_NameAvailabilityApiVersionSubscriptionIdNameType"
        /// /> cmdlet class.
        /// </summary>
        public TestAzRedisCacheNameAvailability_NameAvailabilityApiVersionSubscriptionIdNameType()
        {
        }
        /// <summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="TestAzRedisCacheNameAvailability_NameAvailabilityApiVersionSubscriptionIdNameType"
