namespace Sample.API.Cmdlets
{
    ...
    /// </summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"AzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyTypeExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.Api20171001.IRedisAccessKeys))]
    [Sample.API.Description(@"Regenerate Redis cache's access keys. This operation requires write permission to the cache resource.")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyTypeExpanded : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The Redis access key to regenerate.")]
        [System.Management.Automation.ArgumentCompleter(typeof(Sample.API.Support.RedisKeyType))]
        public Sample.API.Support.RedisKeyType KeyType
        {
            set
            {
                ParametersBody.KeyType = value;
            }
        }
        /// <summary>
        ...
        private Sample.API.Models.Api20171001.IRedisRegenerateKeyParameters _parametersBody= new Sample.API.Models.Api20171001.RedisRegenerateKeyParameters();

        /// <summary>Specifies which Redis access keys to reset.</summary>
        private Sample.API.Models.Api20171001.IRedisRegenerateKeyParameters ParametersBody
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyTypeExpanded
        /// </returns>
        public Sample.API.Cmdlets.NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyTypeExpanded Clone()
        {
        ...
        /// <returns>
        /// an instance of NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyTypeExpanded.
        /// </returns>
        public static Sample.API.Cmdlets.NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyTypeExpanded FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyTypeExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyTypeExpanded"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyTypeExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyTypeExpanded"
        /// /> cmdlet class.
        /// </summary>
        public NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyTypeExpanded()
        {
        }
        ...
        internal NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyTypeExpanded(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parametersBody = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("ParametersBody"), out var __jsonParametersBody) ? Sample.API.Models.Api20171001.RedisRegenerateKeyParameters.FromJson(__jsonParametersBody) : ParametersBody;}
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisRegenerateKey(ResourceGroupName, Name, ApiVersion, SubscriptionId, ParametersBody, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewAzRedisCacheKey_KeyResourceGroupNameNameApiVersionSubscriptionIdKeyTypeExpanded"
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.Api20171001.IRedisAccessKeys" /> from the remote
        /// call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.Api20171001.IRedisAccessKeys> response)
        {
            using( NoSynchronizationContext )
            {
                // onOK - response for 200 / application/json
                // (await response) // should be Sample.API.Models.Api20171001.IRedisAccessKeys
