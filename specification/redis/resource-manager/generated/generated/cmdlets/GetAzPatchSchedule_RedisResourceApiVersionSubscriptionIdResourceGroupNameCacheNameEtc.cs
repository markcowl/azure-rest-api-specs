namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzPatchSchedule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheNameEtc")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.Api20171001.IRedisPatchSchedule))]
    [Sample.API.Description(@"Gets all patch schedules in the specified redis cache (there is only one).")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class GetAzPatchSchedule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheNameEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of GetAzPatchSchedule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheNameEtc
        /// </returns>
        public Sample.API.Cmdlets.GetAzPatchSchedule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheNameEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of GetAzPatchSchedule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheNameEtc.
        /// </returns>
        public static Sample.API.Cmdlets.GetAzPatchSchedule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheNameEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new GetAzPatchSchedule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheNameEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetAzPatchSchedule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheNameEtc"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetAzPatchSchedule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheNameEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzPatchSchedule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheNameEtc"
        /// /> cmdlet class.
        /// </summary>
        public GetAzPatchSchedule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheNameEtc()
        {
        }
        ...
        internal GetAzPatchSchedule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheNameEtc(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PatchSchedulesListByRedisResource(ApiVersion, SubscriptionId, ResourceGroupName, CacheName, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzPatchSchedule_RedisResourceApiVersionSubscriptionIdResourceGroupNameCacheNameEtc"
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.Api20171001.IRedisPatchScheduleListResult" />
        /// from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.Api20171001.IRedisPatchScheduleListResult> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.PatchSchedulesListByRedisResource_Call(requestMessage, onOK, this, Pipeline);
                    }
                }
            }
        }
