namespace Sample.API.Cmdlets
{
    ...
    /// </summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"AzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtc", SupportsShouldProcess = true)]
    ...
    public partial class NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20171001.IRedisCreateParameters _parametersBody= new Sample.API.Models.Api20171001.RedisCreateParameters();

        /// <summary>Parameters supplied to the Create Redis operation.</summary>
        private Sample.API.Models.Api20171001.IRedisCreateParameters ParametersBody
        {
            get
            {
        ...
        public string RedisCreatePropertiesStaticIP
        {
            set
            {
                ParametersBody.Properties = ParametersBody.Properties ?? new Sample.API.Models.Api20171001.RedisCreateProperties();
        ...
        /// <returns>
        /// a duplicate instance of NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtc
        /// </returns>
        public Sample.API.Cmdlets.NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtc.
        /// </returns>
        public static Sample.API.Cmdlets.NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtc"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtc"
        /// /> cmdlet class.
        /// </summary>
        public NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtc()
        {
        }
        ...
        internal NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtc(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parametersBody = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("ParametersBody"), out var __jsonParametersBody) ? Sample.API.Models.Api20171001.RedisCreateParameters.FromJson(__jsonParametersBody) : ParametersBody;}
        }
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtc"
