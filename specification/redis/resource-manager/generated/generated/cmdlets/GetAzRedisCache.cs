namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzRedisCache")]
    ...
    public partial class GetAzRedisCache : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetAzRedisCache</returns>
        public Sample.API.Cmdlets.GetAzRedisCache Clone()
        {
        ...
        /// <returns>an instance of GetAzRedisCache.</returns>
        public static Sample.API.Cmdlets.GetAzRedisCache FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new GetAzRedisCache(json) : null;
        }
        /// <summary>
        ...
        /// <returns>returns a new instance of the <see cref="GetAzRedisCache" /> cmdlet</returns>
        public static Sample.API.Cmdlets.GetAzRedisCache FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>Intializes a new instance of the <see cref="GetAzRedisCache" /> cmdlet class.</summary>
        public GetAzRedisCache()
        {
        }
        ...
        internal GetAzRedisCache(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzRedisCache" /> as a <see cref="Sample.API.Runtime.Json.JsonNode" />.
        /// </returns>
