namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzRedisCache_ResourceGroupResourceGroupNameSubscriptionId")]
    ...
    public partial class GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionId : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionId
        /// </returns>
        public Sample.API.Cmdlets.GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionId Clone()
        {
        ...
        /// <returns>an instance of GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionId.</returns>
        public static Sample.API.Cmdlets.GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionId FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionId(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionId" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionId FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionId" /> cmdlet class.
        /// </summary>
        public GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionId()
        {
        }
        ...
        internal GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionId(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzRedisCache_ResourceGroupResourceGroupNameSubscriptionId" /> as a <see cref="Sample.API.Runtime.Json.JsonNode"
        /// />.
        /// </returns>
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.Api20171001.IRedisListResult" /> from the remote
        /// call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.Api20171001.IRedisListResult> response)
        {
            using( NoSynchronizationContext )
            {
