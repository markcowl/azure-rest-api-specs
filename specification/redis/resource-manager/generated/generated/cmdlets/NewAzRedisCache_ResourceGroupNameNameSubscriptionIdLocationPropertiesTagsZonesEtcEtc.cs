namespace Sample.API.Cmdlets
{
    ...
    /// </summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"AzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtc", SupportsShouldProcess = true)]
    ...
    public partial class NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20180301.IRedisCreateParameters _parameters;

        /// <summary>Parameters supplied to the Create Redis operation.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters supplied to the Create Redis operation.", ValueFromPipeline = true)]
        public Sample.API.Models.Api20180301.IRedisCreateParameters Parameters
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtc
        /// </returns>
        public Sample.API.Cmdlets.NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtc.
        /// </returns>
        public static Sample.API.Cmdlets.NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtc"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtc"
        /// /> cmdlet class.
        /// </summary>
        public NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtc()
        {
        }
        ...
        internal NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtc(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parameters = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("Parameters"), out var __jsonParameters) ? Sample.API.Models.Api20180301.RedisCreateParameters.FromJson(__jsonParameters) : Parameters;}
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisCreate(ResourceGroupName, Name, SubscriptionId, Parameters, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewAzRedisCache_ResourceGroupNameNameSubscriptionIdLocationPropertiesTagsZonesEtcEtc"
