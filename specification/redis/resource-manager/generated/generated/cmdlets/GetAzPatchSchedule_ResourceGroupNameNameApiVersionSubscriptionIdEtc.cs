namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdEtc")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.Api20171001.IRedisPatchSchedule))]
    [Sample.API.Description(@"Gets the patching schedule of a redis cache (requires Premium SKU).")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class GetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of GetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdEtc
        /// </returns>
        public Sample.API.Cmdlets.GetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of GetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdEtc.
        /// </returns>
        public static Sample.API.Cmdlets.GetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new GetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdEtc" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdEtc" /> cmdlet
        /// class.
        /// </summary>
        public GetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdEtc()
        {
        }
        ...
        internal GetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdEtc(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PatchSchedulesGet(ResourceGroupName, Name, ApiVersion, SubscriptionId, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionIdEtc" /> as a <see
