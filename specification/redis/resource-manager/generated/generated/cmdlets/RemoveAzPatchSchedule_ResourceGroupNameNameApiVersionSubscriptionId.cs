namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"AzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionId", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(bool))]
    [Sample.API.Description(@"Deletes the patching schedule of a redis cache (requires Premium SKU).")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class RemoveAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionId : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of RemoveAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionId
        /// </returns>
        public Sample.API.Cmdlets.RemoveAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionId Clone()
        {
        ...
        /// <returns>
        /// an instance of RemoveAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionId.
        /// </returns>
        public static Sample.API.Cmdlets.RemoveAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionId FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new RemoveAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionId(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="RemoveAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionId" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.RemoveAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionId FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PatchSchedulesDelete(ResourceGroupName, Name, ApiVersion, SubscriptionId, onOK, onNoContent, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionId" /> cmdlet
        /// class.
        /// </summary>
        public RemoveAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionId()
        {
        }
        ...
        internal RemoveAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionId(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="RemoveAzPatchSchedule_ResourceGroupNameNameApiVersionSubscriptionId" /> as a <see
