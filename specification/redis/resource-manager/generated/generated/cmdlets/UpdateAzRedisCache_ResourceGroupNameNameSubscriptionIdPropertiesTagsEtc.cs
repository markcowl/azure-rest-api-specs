namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"AzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsEtc", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20180301.IRedisUpdateParameters _parameters;

        /// <summary>Parameters supplied to the Update Redis operation.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters supplied to the Update Redis operation.", ValueFromPipeline = true)]
        public Sample.API.Models.Api20180301.IRedisUpdateParameters Parameters
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsEtc
        /// </returns>
        public Sample.API.Cmdlets.UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsEtc.
        /// </returns>
        public static Sample.API.Cmdlets.UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsEtc" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisUpdate(ResourceGroupName, Name, SubscriptionId, Parameters, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsEtc" /> as a <see
        ...
        internal UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsEtc(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parameters = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("Parameters"), out var __jsonParameters) ? Sample.API.Models.Api20180301.RedisUpdateParameters.FromJson(__jsonParameters) : Parameters;}
        }
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsEtc" />
        /// cmdlet class.
        /// </summary>
        public UpdateAzRedisCache_ResourceGroupNameNameSubscriptionIdPropertiesTagsEtc()
        {
        }
