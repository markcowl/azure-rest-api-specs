namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzRedisCacheUpgradeNotification_UpgradeNotificationsResourceGroupNameNameApiVersionSubscription")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.Api20171001.INotificationListResponse))]
    [Sample.API.Description(@"Gets any upgrade notifications for a Redis cache.")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class GetAzRedisCacheUpgradeNotification_UpgradeNotificationsResourceGroupNameNameApiVersionSubscription : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <summary>how many minutes in past to look for upgrade notifications</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "how many minutes in past to look for upgrade notifications")]
        ...
        /// <returns>
        /// a duplicate instance of GetAzRedisCacheUpgradeNotification_UpgradeNotificationsResourceGroupNameNameApiVersionSubscription
        /// </returns>
        public Sample.API.Cmdlets.GetAzRedisCacheUpgradeNotification_UpgradeNotificationsResourceGroupNameNameApiVersionSubscription Clone()
        {
        ...
        /// <returns>
        /// an instance of GetAzRedisCacheUpgradeNotification_UpgradeNotificationsResourceGroupNameNameApiVersionSubscription.
        /// </returns>
        public static Sample.API.Cmdlets.GetAzRedisCacheUpgradeNotification_UpgradeNotificationsResourceGroupNameNameApiVersionSubscription FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new GetAzRedisCacheUpgradeNotification_UpgradeNotificationsResourceGroupNameNameApiVersionSubscription(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetAzRedisCacheUpgradeNotification_UpgradeNotificationsResourceGroupNameNameApiVersionSubscription"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetAzRedisCacheUpgradeNotification_UpgradeNotificationsResourceGroupNameNameApiVersionSubscription FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzRedisCacheUpgradeNotification_UpgradeNotificationsResourceGroupNameNameApiVersionSubscription"
        /// /> cmdlet class.
        /// </summary>
        public GetAzRedisCacheUpgradeNotification_UpgradeNotificationsResourceGroupNameNameApiVersionSubscription()
        {
        }
        ...
        internal GetAzRedisCacheUpgradeNotification_UpgradeNotificationsResourceGroupNameNameApiVersionSubscription(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_history = If( json?.PropertyT<Sample.API.Runtime.Json.JsonNumber>("History"), out var __jsonHistory) ? (double)__jsonHistory : History;}
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisListUpgradeNotifications(ResourceGroupName, Name, ApiVersion, SubscriptionId, History, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzRedisCacheUpgradeNotification_UpgradeNotificationsResourceGroupNameNameApiVersionSubscription"
        ...
        public Sample.API.Runtime.Json.JsonNode ToJson(Sample.API.Runtime.Json.JsonObject container, Sample.API.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( (Sample.API.Runtime.Json.JsonNode)new Sample.API.Runtime.Json.JsonNumber(History), "History" ,container.Add );
            return container;
        }
        /// <summary>a delegate that is called when the remote service returns 200 (OK).</summary>
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Sample.API.Models.Api20171001.INotificationListResponse" /> from
        /// the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.Api20171001.INotificationListResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    ...
                    {
                        requestMessage = requestMessage.Clone(new System.Uri( result.NextLink ),Sample.API.Runtime.Method.Get );
                        ...
                        await this.Client.RedisListUpgradeNotifications_Call(requestMessage, onOK, this, Pipeline);
                    }
                }
            }
        }
