namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Export, @"AzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainer", SupportsShouldProcess = true)]
    ...
    public partial class ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainer : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        private Sample.API.Models.Api20171001.IExportRDBParameters _parameters;

        /// <summary>Parameters for Redis export operation.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters for Redis export operation.", ValueFromPipeline = true)]
        public Sample.API.Models.Api20171001.IExportRDBParameters Parameters
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainer
        /// </returns>
        public Sample.API.Cmdlets.ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainer Clone()
        {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainer"
        /// /> cmdlet class.
        /// </summary>
        public ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainer()
        {
        }
        ...
        internal ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainer(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_parameters = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("Parameters"), out var __jsonParameters) ? Sample.API.Models.Api20171001.ExportRDBParameters.FromJson(__jsonParameters) : Parameters;}
        }
        /// <summary>
        ...
        /// <returns>
        /// an instance of ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainer.
        /// </returns>
        public static Sample.API.Cmdlets.ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainer FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainer(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainer"
        /// /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainer FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.RedisExportData(ResourceGroupName, Name, ApiVersion, SubscriptionId, Parameters, onOK, onNoContent, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="ExportAzRedisCacheData_DataResourceGroupNameNameApiVersionSubscriptionIdFormatContainer"
