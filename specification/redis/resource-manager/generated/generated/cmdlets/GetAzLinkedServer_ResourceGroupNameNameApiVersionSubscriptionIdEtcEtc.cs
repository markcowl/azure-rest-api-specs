namespace Sample.API.Cmdlets
{
    ...
    /// </summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzLinkedServer_ResourceGroupNameNameApiVersionSubscriptionIdEtcEtc")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.Api20171001.IRedisLinkedServerWithProperties))]
    [Sample.API.Description(@"Gets the list of linked servers associated with this redis cache (requires Premium SKU).")]
    [Sample.API.Generated]
    [Sample.API.Profile("hybrid-2019", "latest", "sample")]
    public partial class GetAzLinkedServer_ResourceGroupNameNameApiVersionSubscriptionIdEtcEtc : System.Management.Automation.PSCmdlet, Sample.API.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of GetAzLinkedServer_ResourceGroupNameNameApiVersionSubscriptionIdEtcEtc
        /// </returns>
        public Sample.API.Cmdlets.GetAzLinkedServer_ResourceGroupNameNameApiVersionSubscriptionIdEtcEtc Clone()
        {
        ...
        /// <returns>
        /// an instance of GetAzLinkedServer_ResourceGroupNameNameApiVersionSubscriptionIdEtcEtc.
        /// </returns>
        public static Sample.API.Cmdlets.GetAzLinkedServer_ResourceGroupNameNameApiVersionSubscriptionIdEtcEtc FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
            return node is Sample.API.Runtime.Json.JsonObject json ? new GetAzLinkedServer_ResourceGroupNameNameApiVersionSubscriptionIdEtcEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetAzLinkedServer_ResourceGroupNameNameApiVersionSubscriptionIdEtcEtc" /> cmdlet
        /// </returns>
        public static Sample.API.Cmdlets.GetAzLinkedServer_ResourceGroupNameNameApiVersionSubscriptionIdEtcEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Sample.API.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzLinkedServer_ResourceGroupNameNameApiVersionSubscriptionIdEtcEtc" />
        /// cmdlet class.
        /// </summary>
        public GetAzLinkedServer_ResourceGroupNameNameApiVersionSubscriptionIdEtcEtc()
        {
        }
        ...
        internal GetAzLinkedServer_ResourceGroupNameNameApiVersionSubscriptionIdEtcEtc(Sample.API.Runtime.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.LinkedServerList(ResourceGroupName, Name, ApiVersion, SubscriptionId, onOK, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzLinkedServer_ResourceGroupNameNameApiVersionSubscriptionIdEtcEtc" /> as a <see
        ...
        /// <param name="response">the body result as a <see cref="Sample.API.Models.Api20171001.IRedisLinkedServerWithPropertiesList"
        /// /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Sample.API.Models.Api20171001.IRedisLinkedServerWithPropertiesList> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.LinkedServerList_Call(requestMessage, onOK, this, Pipeline);
                    }
                }
            }
        }
