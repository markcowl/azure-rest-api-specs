namespace Sample.API.Models.Api20180301
{
    ...
    public partial class RedisCreateParameters
    {
        ...
        public static Sample.API.Models.Api20180301.IRedisCreateParameters FromJsonString(string jsonText) => FromJson(Sample.API.Runtime.Json.JsonNode.Parse(jsonText));
