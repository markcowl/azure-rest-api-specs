namespace Sample.API.Models.Api20180301
{
    ...
    /// </summary>
    public partial class RedisCreateParametersTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                RedisCreateParameters.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new RedisCreateParameters
                {
                Location = sourceValue.Location,
                Properties = Sample.API.Models.Api20180301.RedisCreatePropertiesTypeConverter.ConvertFrom(sourceValue.Properties),
                Tag = sourceValue.Tag,
                Zones = sourceValue.Zones,
                };
            }
            catch
            {
