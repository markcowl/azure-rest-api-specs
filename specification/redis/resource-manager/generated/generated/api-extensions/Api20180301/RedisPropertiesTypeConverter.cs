namespace Sample.API.Models.Api20180301
{
    ...
    /// </summary>
    public partial class RedisPropertiesTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                RedisProperties.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                {
                AccessKeys = Sample.API.Models.Api20171001.RedisAccessKeysTypeConverter.ConvertFrom(sourceValue.AccessKeys),
                HostName = sourceValue.HostName,
                LinkedServers = sourceValue.LinkedServers,
                Port = sourceValue.Port,
                ProvisioningState = sourceValue.ProvisioningState,
                RedisVersion = sourceValue.RedisVersion,
                SslPort = sourceValue.SslPort,
                };
            }
            catch
            {
