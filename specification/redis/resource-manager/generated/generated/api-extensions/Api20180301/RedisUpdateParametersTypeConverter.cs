namespace Sample.API.Models.Api20180301
{
    ...
    /// </summary>
    public partial class RedisUpdateParametersTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                RedisUpdateParameters.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new RedisUpdateParameters
                {
                Properties = Sample.API.Models.Api20180301.RedisUpdatePropertiesTypeConverter.ConvertFrom(sourceValue.Properties),
                Tag = sourceValue.Tag,
                };
            }
            catch
