namespace Sample.API.Models.Api20171001
{
    ...
    /// </summary>
    public partial class RedisFirewallRulePropertiesTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                RedisFirewallRuleProperties.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new RedisFirewallRuleProperties
                {
                EndIP = sourceValue.EndIP,
                StartIP = sourceValue.StartIP,
                };
            }
            catch
            {
