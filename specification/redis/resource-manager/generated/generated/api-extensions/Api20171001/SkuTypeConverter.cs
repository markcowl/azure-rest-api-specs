namespace Sample.API.Models.Api20171001
{
    ...
    /// </summary>
    public partial class SkuTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                Sku.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                Capacity = sourceValue.Capacity,
                Family = sourceValue.Family,
                };
            }
            catch
            {
