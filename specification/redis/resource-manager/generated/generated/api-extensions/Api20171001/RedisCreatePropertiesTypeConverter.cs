namespace Sample.API.Models.Api20171001
{
    ...
    /// </summary>
    public partial class RedisCreatePropertiesTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                RedisCreateProperties.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                {
                Sku = Sample.API.Models.Api20171001.SkuTypeConverter.ConvertFrom(sourceValue.Sku),
                StaticIP = sourceValue.StaticIP,
                SubnetId = sourceValue.SubnetId,
                };
            }
            catch
            {
