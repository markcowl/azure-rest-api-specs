namespace Sample.API.Models.Api20171001
{
    ...
    /// </summary>
    public partial class ScheduleEntryTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                ScheduleEntry.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                {
                DayOfWeek = sourceValue.DayOfWeek,
                MaintenanceWindow = sourceValue.MaintenanceWindow,
                StartHourUtc = sourceValue.StartHourUtc,
                };
            }
            catch
            {
