namespace Sample.API.Models.Api20171001
{
    ...
    /// </summary>
    public partial class UpgradeNotificationTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                UpgradeNotification.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new UpgradeNotification
                {
                Name = sourceValue.Name,
                Timestamp = sourceValue.Timestamp,
                UpsellNotification = sourceValue.UpsellNotification,
                };
            }
            catch
            {
