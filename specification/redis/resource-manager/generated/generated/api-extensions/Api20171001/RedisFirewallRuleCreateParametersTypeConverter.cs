namespace Sample.API.Models.Api20171001
{
    ...
    /// </summary>
    public partial class RedisFirewallRuleCreateParametersTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                RedisFirewallRuleCreateParameters.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new RedisFirewallRuleCreateParameters
                {
                Properties = Sample.API.Models.Api20171001.RedisFirewallRulePropertiesTypeConverter.ConvertFrom(sourceValue.Properties),
                };
            }
            catch
            {
