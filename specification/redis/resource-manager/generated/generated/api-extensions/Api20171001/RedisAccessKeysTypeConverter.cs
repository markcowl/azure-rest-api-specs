namespace Sample.API.Models.Api20171001
{
    ...
    /// </summary>
    public partial class RedisAccessKeysTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                RedisAccessKeys.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new RedisAccessKeys
                {
                PrimaryKey = sourceValue.PrimaryKey,
                SecondaryKey = sourceValue.SecondaryKey,
                };
            }
            catch
            {
