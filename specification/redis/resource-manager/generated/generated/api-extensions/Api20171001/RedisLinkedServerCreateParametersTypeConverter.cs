namespace Sample.API.Models.Api20171001
{
    ...
    /// </summary>
    public partial class RedisLinkedServerCreateParametersTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                RedisLinkedServerCreateParameters.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new RedisLinkedServerCreateParameters
                {
                Properties = Sample.API.Models.Api20171001.RedisLinkedServerCreatePropertiesTypeConverter.ConvertFrom(sourceValue.Properties),
                };
            }
            catch
            {
