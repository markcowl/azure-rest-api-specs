namespace Sample.API.Models.Api20171001
{
    ...
    /// </summary>
    public partial class RedisRebootParametersTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                RedisRebootParameters.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new RedisRebootParameters
                {
                RebootType = sourceValue.RebootType,
                ShardId = sourceValue.ShardId,
                };
            }
            catch
            {
