namespace Sample.API.Models.Api20171001
{
    ...
    /// </summary>
    public partial class RedisLinkedServerCreatePropertiesTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                RedisLinkedServerCreateProperties.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                {
                LinkedRedisCacheId = sourceValue.LinkedRedisCacheId,
                LinkedRedisCacheLocation = sourceValue.LinkedRedisCacheLocation,
                ServerRole = sourceValue.ServerRole,
                };
            }
            catch
            {
