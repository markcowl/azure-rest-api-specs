namespace Sample.API.Models.Api20171001
{
    ...
    /// </summary>
    public partial class RedisLinkedServerWithPropertiesTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                RedisLinkedServerWithProperties.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new RedisLinkedServerWithProperties
                {
                Properties = Sample.API.Models.Api20171001.RedisLinkedServerPropertiesTypeConverter.ConvertFrom(sourceValue.Properties),
                };
            }
            catch
            {
