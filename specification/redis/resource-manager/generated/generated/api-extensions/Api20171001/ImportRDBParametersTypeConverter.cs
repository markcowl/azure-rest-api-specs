namespace Sample.API.Models.Api20171001
{
    ...
    /// </summary>
    public partial class ImportRDBParametersTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                ImportRDBParameters.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new ImportRDBParameters
                {
                Format = sourceValue.Format,
                Files = sourceValue.Files,
                };
            }
            catch
            {
