namespace Sample.API.Models.Api20171001
{
    ...
    /// </summary>
    public partial class OperationTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                Operation.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                Display = Sample.API.Models.Api20171001.OperationDisplayTypeConverter.ConvertFrom(sourceValue.Display),
                };
            }
            catch
            {
