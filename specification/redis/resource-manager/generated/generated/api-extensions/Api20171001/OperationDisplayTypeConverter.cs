namespace Sample.API.Models.Api20171001
{
    ...
    /// </summary>
    public partial class OperationDisplayTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                OperationDisplay.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                Operation = sourceValue.Operation,
                Provider = sourceValue.Provider,
                Resource = sourceValue.Resource,
                };
            }
            catch
            {
