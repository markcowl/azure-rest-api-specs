namespace Sample.API.Models.Api20171001
{
    ...
    /// </summary>
    public partial class RedisPatchScheduleTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                RedisPatchSchedule.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new RedisPatchSchedule
                {
                Properties = Sample.API.Models.Api20171001.ScheduleEntriesTypeConverter.ConvertFrom(sourceValue.Properties),
                };
            }
            catch
            {
