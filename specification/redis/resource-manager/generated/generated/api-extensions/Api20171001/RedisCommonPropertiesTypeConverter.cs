namespace Sample.API.Models.Api20171001
{
    ...
    /// </summary>
    public partial class RedisCommonPropertiesTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                RedisCommonProperties.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                {
                EnableNonSslPort = sourceValue.EnableNonSslPort,
                RedisConfiguration = sourceValue.RedisConfiguration,
                ShardCount = sourceValue.ShardCount,
                TenantSettings = sourceValue.TenantSettings,
                };
            }
            catch
            {
