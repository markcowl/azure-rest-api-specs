namespace Sample.API.Models.Api20180301
{
    ...
    public partial class RedisUpdateParameters : Sample.API.Models.Api20180301.IRedisUpdateParameters, Sample.API.Runtime.IValidates
    {
        /// <summary>Backing field for <see cref="Properties" /> property.</summary>
        private Sample.API.Models.Api20180301.IRedisUpdateProperties _properties;

        /// <summary>Redis cache properties.</summary>
        public Sample.API.Models.Api20180301.IRedisUpdateProperties Properties
        {
            get
            {
    ...
    public partial interface IRedisUpdateParameters : Sample.API.Runtime.IJsonSerializable {
        Sample.API.Models.Api20180301.IRedisUpdateProperties Properties { get; set; }
