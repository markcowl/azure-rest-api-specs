namespace Sample.API.Models.Api20180301
{
    ...
    public partial class RedisResource : Sample.API.Models.Api20180301.IRedisResource, Sample.API.Runtime.IValidates
    {
        ...
        private Sample.API.Models.Api20180301.IRedisProperties _properties;

        /// <summary>Redis cache properties.</summary>
        public Sample.API.Models.Api20180301.IRedisProperties Properties
        {
            get
            {
    ...
    public partial interface IRedisResource : Sample.API.Runtime.IJsonSerializable, Sample.API.Models.Api20171001.ITrackedResource {
        Sample.API.Models.Api20180301.IRedisProperties Properties { get; set; }
