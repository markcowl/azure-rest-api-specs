namespace Sample.API.Models.Api20180301
{
    ...
    public partial class RedisUpdateParameters
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Sample.API.Runtime.Json.JsonNode"/> into an instance of Sample.API.Models.Api20180301.IRedisUpdateParameters.
        /// </summary>
        /// <param name="node">a <see cref="Sample.API.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.Api20180301.IRedisUpdateParameters.</returns>
        public static Sample.API.Models.Api20180301.IRedisUpdateParameters FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
        ...
        internal RedisUpdateParameters(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_properties = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Sample.API.Models.Api20180301.RedisUpdateProperties.FromJson(__jsonProperties) : Properties;}
