namespace Sample.API.Models.Api20171001
{
    ...
    public partial class RedisCreateParameters
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Sample.API.Runtime.Json.JsonNode"/> into an instance of Sample.API.Models.Api20171001.IRedisCreateParameters.
        /// </summary>
        /// <param name="node">a <see cref="Sample.API.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Sample.API.Models.Api20171001.IRedisCreateParameters.</returns>
        public static Sample.API.Models.Api20171001.IRedisCreateParameters FromJson(Sample.API.Runtime.Json.JsonNode node)
        {
        ...
        internal RedisCreateParameters(Sample.API.Runtime.Json.JsonObject json)
        {
            ...
            {_properties = If( json?.PropertyT<Sample.API.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Sample.API.Models.Api20171001.RedisCreateProperties.FromJson(__jsonProperties) : Properties;}
