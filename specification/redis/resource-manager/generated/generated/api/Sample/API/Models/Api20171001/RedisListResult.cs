namespace Sample.API.Models.Api20171001
{
    ...
    public partial class RedisListResult : Sample.API.Models.Api20171001.IRedisListResult, Sample.API.Runtime.IValidates
    {
        /// <summary>Backing field for <see cref="NextLink" /> property.</summary>
        private string _nextLink;

        /// <summary>Link for next set of locations.</summary>
        ...
        private Sample.API.Models.Api20171001.IRedisResource[] _value;

        /// <summary>List of Redis cache instances.</summary>
        public Sample.API.Models.Api20171001.IRedisResource[] Value
        {
            get
            {
                return this._value;
    ...
    public partial interface IRedisListResult : Sample.API.Runtime.IJsonSerializable {
        string NextLink { get;  }
        Sample.API.Models.Api20171001.IRedisResource[] Value { get; set; }
    }
}